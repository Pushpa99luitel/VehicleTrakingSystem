package com.pushpa.vehicletrackingsystem.login;
...
import com.pushpa.vehicletrackingsystem.ProfileActivity;
import com.pushpa.vehicletrackingsystem.R;
import com.pushpa.vehicletrackingsystem.ui.DiverMapsActivity;
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                dialog.dismiss();
                                Intent intent = new Intent(DriverLoginRegisterActivity.this, ProfileActivity.class);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(DriverLoginRegisterActivity.this, DiverMapsActivity.class));
